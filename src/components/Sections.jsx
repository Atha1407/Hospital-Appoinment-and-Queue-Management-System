        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto lg:mx-0">
              Transform your hospital visits with our intelligent digital
              platform. Book appointments instantly, track your queue status in
              real-time, and get the care you need without the wait.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            We provide a seamless platform that empowers patients to manage
            their health journey while optimizing hospital workflows for better
            service delivery.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "For Patients",
              desc: "Skip the waiting room. Book appointments online, receive real-time queue updates, and arrive exactly when it's your turn.",
              icon: <Users className="h-8 w-8 text-blue-500" />,
            },
            {
              title: "For Doctors",
              desc: "Manage your daily schedule efficiently. View upcoming patient details and minimize no-shows with automated reminders.",
              icon: <Stethoscope className="h-8 w-8 text-teal-500" />,
            },
            {
              title: "For Hospitals",
              desc: "Streamline operations and reduce front-desk congestion. Improve overall patient satisfaction and facility throughput.",
              icon: <Hospital className="h-8 w-8 text-indigo-500" />,
            },
          ].map((item, idx) => (
            <motion.div
              key={idx}
  ...
  const features = [
    {
      ...
      desc: "Schedule visits 24/7 with your preferred doctors across multiple departments.",
      icon: <Calendar className="h-6 w-6" />,
    },
    {
      title: "Smart Queue Management",
      desc: "Real-time tracking of your position in the queue, reducing physical wait times.",
      icon: <Clock className="h-6 w-6" />,
    },
    {
      title: "Multiple Hospital Support",
      desc: "Access services from a wide network of partner hospitals from a single account.",
      icon: <Hospital className="h-6 w-6" />,
    },
    {
      title: "Secure Patient Records",
      desc: "Your medical history and prescriptions are encrypted and stored securely.",
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8">
              Our comprehensive suite of tools is designed to eliminate the
              friction from healthcare access. From the moment you feel unwell
  ...
  const steps = [
    {
      ...
      desc: "Create a free account to get started.",
      icon: <UserPlus className="h-6 w-6" />,
    },
    {
      num: "02",
      title: "Choose Hospital",
      desc: "Select from our network of facilities.",
      icon: <Hospital className="h-6 w-6" />,
    },
    {
      num: "03",
    ...
    },
    {
      num: "04",
      title: "Track Queue",
      desc: "Monitor your turn in real-time.",
      icon: <Clock className="h-6 w-6" />,
    },
    {
      num: "05",
      title: "Visit Doctor",
      desc: "Arrive just in time for your consultation.",
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            Five simple steps to a better healthcare experience.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Automated booking system with calendar integration and conflict resolution.",
            },
            {
              title: "Queue Tracking",
              desc: "Live display of current serving numbers and estimated wait times.",
            },
            {
              title: "Hospital Management",
              desc: "Backend dashboard for administrators to monitor patient flow and staff.",
            },
            {
              title: "Patient Records",
              desc: "Centralized database for prescriptions, test results, and medical history.",
            },
          ].map((service, idx) => (
            <div
              key={idx}
...
export const Testimonials = () => {
  const reviews = [
    {
      quote:
        "I used to spend hours waiting to see my cardiologist. With CareQueue, I arrive 10 minutes before my actual turn. It's life-changing.",
      author: "Sarah Jenkins",
      role: "Patient",
    },
    {
      quote:
        "The dashboard is incredibly intuitive. It has reduced our front-desk workload by 40% and improved our daily patient throughput significantly.",
      author: "Dr. Michael Chen",
      role: "Hospital Administrator",
    },
    {
      quote:
        "I love being able to track my queue status from my phone while having a coffee nearby instead of sitting in a crowded waiting room.",
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
          Ready to simplify your hospital visits?
        </h2>
        <p className="text-xl text-slate-300 mb-10">
          Join thousands of users who have transformed their healthcare
          experience. Register today for free.
        </p>
