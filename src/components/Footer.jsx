...
export default function Footer() {
  return (
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 text-white">
              ...
              <span className="text-2xl font-bold tracking-tight">CareQueue</span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed">
              Transforming healthcare access through intelligent queue management and seamless digital appointments.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#home" className="hover:text-white transition-colors flex items-center space-x-2"><span className="text-primary text-xs">▶</span><span>Home</span></a></li>
              <li><a href="#about" className="hover:text-white transition-colors flex items-center space-x-2"><span className="text-primary text-xs">▶</span><span>About Us</span></a></li>
              <li><a href="#services" className="hover:text-white transition-colors flex items-center space-x-2"><span className="text-primary text-xs">▶</span><span>Services</span></a></li>
              <li><a href="#features" className="hover:text-white transition-colors flex items-center space-x-2"><span className="text-primary text-xs">▶</span><span>Features</span></a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-sm">support@carequeue.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} CareQueue Systems. All rights reserved.
          </p>
