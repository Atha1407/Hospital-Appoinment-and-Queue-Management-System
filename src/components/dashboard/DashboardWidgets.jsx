  ...
  <Card className="col-span-1 md:col-span-2 lg:col-span-1">
    ...
    <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
      <div className="flex gap-4 border-b border-gray-200 pb-4 mb-4">
        ...
        <div>
          <h4 className="font-bold text-gray-900 text-lg">Dr. Sarah Jenkins</h4>
          <p className="text-sm text-gray-500">Cardiologist • City Hospital</p>
        </div>
      </div>
...
export const QueueStatus = () => (
  <Card>
    ...
    <div className="text-center mb-6">
      ...
      <div className="text-5xl font-black text-blue-600 tracking-tight">#42</div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="bg-teal-50 rounded-xl p-4 border border-teal-100 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-teal-900">Estimated Wait: ~15 mins</p>
          <p className="text-xs text-teal-700 mt-1">Please head to the waiting area near Room 302.</p>
        </div>
      </div>
    </div>
  </Card>
